// -*- c-basic-offset: 4 -*-
#ifndef CLICK_TDMAPULLSCHEDULER_HH
#define CLICK_TDMAPULLSCHEDULER_HH
...
/*
 * =c
 * TdmaPullScheduler derived from 
 * 	PrioSched
 * 	Documentation pending - Ashish
 *
 * =s scheduling
...
class TdmaPullScheduler : public Element { public:
  
    TdmaPullScheduler();
    ~TdmaPullScheduler();
  
    const char *class_name() const	{ return "TdmaPullScheduler"; }
